...
# ============================================================================
# SWIN TRANSFORMER COMPONENTS (Encoder Only)
# ============================================================================
...
class SwinEncoder(nn.Module):
    ...
    This encoder uses Swin Transformer as backbone and provides 4 feature levels
    at different scales (strides 4, 8, 16, 32) suitable for CNN decoders.
    """
    ...
    def forward(self, x):
        ...
        # Don't add the final normalized feature - we want exactly 4 features
        # x = self.norm(x)  # B L C
        # features.append(x)
