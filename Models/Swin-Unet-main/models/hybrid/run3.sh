#!/bin/bash -l
#SBATCH --job-name=syr341fs_baseline_smart_skip_ds_groupnorm
#SBATCH --output=./Results/a2/syr341fs_baseline_smart_skip_ds_groupnorm_%j.out
#SBATCH --error=./Results/a2/syr341fs_baseline_smart_skip_ds_groupnorm_%j.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
for MANUSCRIPT in "${MANUSCRIPTS[@]}"; do
    ...
    echo "  ✓ Deep Supervision (remove --use_deep_supervision flag to disable deep supervision)"
